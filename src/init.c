...
static const R_CallMethodDef CallEntries[] = {
  /* Прямые вызовы основных функций */
  {"_MatrixProd_rust_mmTiny_cpp", (DL_FUNC) &rust_mmTiny_cpp, 2},
  {"_MatrixProd_cpp_mmAccelerate", (DL_FUNC) &cpp_mmAccelerate, 2},
